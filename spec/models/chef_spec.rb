...
RSpec.describe Chef, type: :model do
  ...
  describe 'instance methods' do
    ...
    describe '.all_ingredients' do
      it 'returns all ingredients used in dishes by this chef' do
        expect(@chef.all_ingredients.sort).to eq([@ingredient_1, @ingredient_2, @ingredient_3, @ingredient_4, @ingredient_5, @ingredient_6].sort) 
      end
    end
  end
end